  ...
  ketcher.getMolfile().then(function (mol) {
    ...
    for (i = 0; i < symboles.length; i++) {
      if (symboles[i] !== "Mg" && symboles[i] !== "Cl") {
        feedback.innerText =
          "Ce composé ionique ne contient que des ions Mg<sup>2+</sup> et Cl<sup>-</sup>.";
        return;
      }
    }
    ...
    for (i = 0; i < symboles.length; i++) {
      ...
      if (symboles[i] === "Mg" && charge !== 2) {
        feedback.innerHTML =
          ...
          "Dans l'exercice précédent, vous avez déterminé que le Mg forme Mg<sup>2+</sup> et Cl forme Cl<sup>-</sup>.";
        return;
      }
    ...
    /* ==================================================
       ...
       ================================================== */
    feedback.innerHTML =
      "Bravo ! Votre représentation des ions Mg<sup>2+</sup> et Cl<sup>-</sup> " +
      "séparés du MgCl<sub>2</sub> est correcte";
